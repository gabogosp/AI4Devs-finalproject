...
**Estado**: backend vivo. FE (control de estrellas en la ficha, lista de
reseñas, moderación admin) y QA todavía pendientes — ver `us-status.yaml`.
...
Suite dev-owned del backend (Jest + supertest contra Postgres real, sin
