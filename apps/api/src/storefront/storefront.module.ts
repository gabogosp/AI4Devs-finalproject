 ...
 * + US-025 reseñas públicas). Importa los módulos que exportan los
 * repositorios (únicos puntos de acceso al ORM) y registra los controllers
 * públicos + su service. Se cablea en `AppModule`.
 */
@Module({
